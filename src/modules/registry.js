...
export const PALETTES = {
  ...
  green: {
    ...
    dot: 'bg-emerald-400',
    rowBorder: 'border-emerald-500/15 hover:border-emerald-500/40',
  ...
  cyan: {
    ...
    dot: 'bg-cyan-400',
    rowBorder: 'border-cyan-500/15 hover:border-cyan-500/40',
  ...
  orange: {
    ...
    dot: 'bg-orange-400',
    rowBorder: 'border-orange-500/15 hover:border-orange-500/40',
  ...
  violet: {
    ...
    dot: 'bg-violet-400',
    rowBorder: 'border-violet-500/15 hover:border-violet-500/40',
  ...
  rose: {
    ...
    dot: 'bg-rose-400',
    rowBorder: 'border-rose-500/15 hover:border-rose-500/40',
